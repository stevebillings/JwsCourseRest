...
set JAXRS_LIB=%JAXRS_PATH%\jersey-server.jar;%JAXRS_PATH%\jersey-common.jar;%JAXRS_PATH%\jersey-container-servlet.jar;%JAXRS_PATH%\jersey-container-servlet-core.jar;%JAXRS_API%\javax.ws.rs-api-2.0.jar
